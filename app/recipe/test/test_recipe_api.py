...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Breakfast cereal')
        recipe2 = sample_recipe(user=self.user, title='Strawberry shortcake')
        recipe3 = sample_recipe(user=self.user, title='Fish and chips')
        tag1 = sample_tag(user=self.user, name='Breakfast')
        tag2 = sample_tag(user=self.user, name='Sweets')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Strawberry shortcake')
        recipe3 = sample_recipe(user=self.user, title='Fish and chips')
        ingredient1 = sample_ingredient(user=self.user, name='Cereal')
        ingredient2 = sample_ingredient(user=self.user, name='Strawberry')
